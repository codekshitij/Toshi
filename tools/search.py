...
def search_company(name: str) -> str:
    ...
    if cached:
        ...
        results = client.search_company(name)
    ...
    # Format results nicely for Claude to read
...
def get_filings(cik_padded: str, filing_type: str = "10-K", limit: int = 5) -> str:
    ...
    if cached:
        ...
        submissions = client.get_company_submissions(cik_padded)
        cache.set_cached("company_submissions", "cik_padded", cik_padded, submissions)
